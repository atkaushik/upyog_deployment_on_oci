...
variable "compartment_ocid" { default = "ocid1.compartment.oc1..aaaaaaaajn5ikvyyi3avayze47mqwwizhc6mt4hn4mbjqr4ocivarplo7seq" }

variable "tenancy_ocid" { default = "ocid1.tenancy.oc1..aaaaaaaayn6s77e3y4hgz56uzwvay3jrpekafo6ycr5pr5xdsg3gahcygx7a" }
